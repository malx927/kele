...
from .models import BathOrder

#宠物保险登记表单
class BathOrderForm(forms.ModelForm):

    def __init__(self, *args,**kwargs):
        super(BathOrderForm,self).__init__(*args,**kwargs)

        self.fields['bath_room'].widget.attrs['class'] = 'weui-select'
        self.fields['bath_room'].empty_label = "请选择浴台"

        self.fields['pet_weight'].widget.attrs['class'] = 'weui-input'
        self.fields['pet_weight'].widget.attrs['type'] = 'number'

        self.fields['start_time'].widget.attrs['class'] = 'weui-input'
        ...
        self.fields['total_fee'].widget.attrs['type'] = 'number'
        self.fields['total_fee'].widget.attrs['readonly'] = 'true'

    class Meta:
        model = BathOrder
        fields = ['bath_room', 'pet_weight', 'start_time', 'end_time', 'total_fee']

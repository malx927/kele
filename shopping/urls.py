...
from .views import index, GoodsDetailView, GoodsBuyListView, CreateOrderView, PayOrderView, payNotify
...
urlpatterns = [
    ...
    url(r'^createorder/$', CreateOrderView.as_view(), name='create-order'), #创建订单
    url(r'^payorder/$', PayOrderView.as_view(), name='pay-order'), #支付订单

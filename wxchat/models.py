...
class WxUserinfo(models.Model):
    subscribe = models.BooleanField(verbose_name='是否订阅', default=0)
    ...
    unionid = models.CharField(verbose_name='统一标识', max_length=64)
    remark = models.CharField(verbose_name='备注', max_length=64)
    groupid = models.CharField(verbose_name='分组ID', max_length=32)
    tagid_list = models.CharField(verbose_name='标签列表', max_length=64)
    subscribe_scene = models.CharField(verbose_name='渠道来源', max_length=64)
    qr_scene = models.CharField(verbose_name='扫码场景', max_length=32)
    qr_scene_str = models.CharField(verbose_name='扫码场景描述', max_length=64)
